...
* **CHANGED:** FFmpeg Standard Deinterlace removed (now considered deprecated)
* **CHANGED:** Tweaks to CBR buffer encoding parameters
* **CHANGED:** Audio bitrate options now disabled for lossless codecs
* **CHANGED:** Automatically set default codecs for selected format on format change
* **CHANGED:** Disables including video and/or audio when not available
* **CHANGED:** Added album and disables unavailable metadata options
...
* **CHANGED:** Refreshed user interface
* **CHANGED:** Start and stop points temporarily removed due to incomplete implementation
* **CHANGED:** Save file dialog now automatically chooses the extension for the selected format
* **CHANGED:** Codec lists now change to show only codecs compatible with the selected container
* **CHANGED:** Changed license from GPL v2 to GPL v3
